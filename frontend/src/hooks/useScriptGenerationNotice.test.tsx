...
const SCRIPT_TOOL = "mcp__vimage__generate_episode_script";
const SCRIPT_PLAN_TOOL = "mcp__vimage__generate_script_plan";
    ...
    act(() => {
      useAssistantStore.setState({
        draftTurn: assistantTurn(
          toolUse("mcp__vimage__generate_storyboards", "tu-sb"),
