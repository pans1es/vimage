...
import { CaretLeft, Pulse, GearSix, Bell, DownloadSimple, CircleNotch, Package } from "@phosphor-icons/react";
...
export function GlobalHeader({ onNavigateBack }: GlobalHeaderProps) {
  ...
  return (
    <>
      <header
        className="relative grid shrink-0 items-center px-4"
        style={{
      ...
      >
        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline font-medium tracking-tight">{t("dashboard:projects")}</span>
          </button>
          <div
            aria-hidden="true"
            className="h-4 w-px"
        ...
        <div className="flex items-center gap-1">
          <div className="relative" ref={notificationAnchorRef}>
            <Button
              ...
              className={cn(
                ...
                notificationDrawerOpen &&
                  "bg-[var(--color-accent-dim)] text-[var(--color-accent)] hover:bg-[var(--color-accent-dim)] hover:text-[var(--color-accent)]",
              )}
            ...
            >
              <Bell className={iconClass.sm} weight={ICON.weight} />
          ...
          <div className="relative" ref={usageAnchorRef}>
            <button
              ...
              className={cn(
                "inline-flex items-center gap-2 rounded-md px-2.5 py-[5px] text-[11.5px] transition-colors focus-ring",
                usageDrawerOpen && "bg-[var(--color-accent-dim)]",
              )}
              style={{
          ...
          <div className="relative" ref={taskHudAnchorRef}>
            ...
            >
              <Pulse
                className={cn(iconClass.md, runningCount > 0 && "animate-shot-pulse")}
                weight={ICON.weight}
              />
              {runningCount > 0 && (
                <span
          ...
          >
            ...
            >
              {exportingProject ? (
                <CircleNotch className={cn(iconClass.sm, "animate-spin")} weight={ICON.weight} />
              ) : (
                <DownloadSimple className={iconClass.sm} weight={ICON.weight} />
              )}
          ...
          >
            <Package className={iconClass.md} weight={ICON.weight} />
          </Button>
          ...
          >
            <GearSix className={iconClass.md} weight={ICON.weight} />
