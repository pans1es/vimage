        ...
        {workspaceNotifications.length === 0 ? (
          <div
            ...
            style={{
              ...
              background:
                "radial-gradient(400px 200px at 50% -10%, var(--color-accent-dim), transparent 60%), var(--color-field-muted)",
            }}
          >
            <span
              aria-hidden
                ...
                <article
                  ...
                  style={{
                    ...
                    background: actionable
                      ? "linear-gradient(135deg, var(--color-accent-dim) 0%, var(--color-field-muted) 60%)"
                      : tone.soft,
