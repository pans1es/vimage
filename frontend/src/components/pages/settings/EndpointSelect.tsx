    ...
    <>
      <button
        ...
        className={[
          ...
          "border-hairline bg-field text-text",
      ...
      >
                      ...
                      <li key={opt.value}>
                        <button
                          ...
                          className={[
                            ...
                            isActive && !isSelected ? "bg-field-muted" : "",
                          ].join(" ")}
                        >
                          <div
        ...
        <button
          ...
          className="flex shrink-0 items-center gap-1.5 border-t border-hairline-soft px-3.5 py-2 text-left text-[12px] text-text-3 transition-colors hover:bg-field-muted hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
