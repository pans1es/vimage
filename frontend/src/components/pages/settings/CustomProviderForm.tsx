...
const COMPACT_INPUT_CLS =
  "min-w-0 rounded-[2px] border border-hairline bg-field px-2 py-1 text-[12.5px] text-text placeholder:text-text-3 transition-colors hover:border-hairline-strong focus:border-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent";
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            disabled={isEdit}
            className="rounded-[6px] border border-hairline bg-field px-2 py-1 text-[11.5px] text-text-2 hover:border-hairline-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50"
          >
                  ...
                  >
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <label className="flex cursor-pointer items-center gap-1.5">
                        <input
                          ...
                          className="h-3.5 w-3.5 cursor-pointer rounded border-hairline bg-field accent-[var(--color-accent)]"
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2 pl-6 text-[11px] text-text-4">
                      <select
                        ...
                        className="rounded-[5px] border border-hairline bg-field px-1 py-0.5 text-[11px] text-text-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                      >
        ...
        {/* Empty model hint */}
        {models.length === 0 && (
          <div className="rounded-[10px] border border-dashed border-hairline-strong bg-field-muted p-4 text-center text-[12.5px] text-text-3">
