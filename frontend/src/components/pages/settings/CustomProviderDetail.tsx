              ...
              <div className="space-y-1.5">
                {provider.models.map((m) => (
                  ...
                  >
                    ...
                    <span className="rounded-full border border-hairline-soft bg-field px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[0.14em] text-text-3">
                      {(() => {
        ...
        <div className="flex items-center gap-3">
          ...
          {!confirmDelete ? (
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-[8px] border border-hairline bg-field px-3 py-1.5 text-[12.5px] text-text-3 transition-colors hover:border-warm-ring hover:text-warm-bright focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
            >
