...
export function ProviderSection() {
    ...
    return (
      <div role="alert" className="flex flex-col items-start gap-2.5 px-6 py-8">
        ...
        <button
          ...
          className="rounded-[7px] border border-hairline-soft bg-field px-3 py-1.5 text-[12px] text-text-2 transition-colors hover:border-hairline hover:text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
        >
          {t("common:retry")}
        </button>
      </div>
  ...
  return (
    <div className="flex">
      ...
      >
        <div className="mb-2 px-3 font-mono text-[9.5px] font-bold uppercase tracking-[0.16em] text-text-3">
          {t("preset_providers")}
        </div>
        {providers.map((p) => {
          const isActive =
          ...
          return (
            <button
              ...
              className={
                "group relative mb-0.5 flex w-full items-center gap-2.5 rounded-[6px] border px-3 py-2 text-left text-[12.5px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent " +
                (isActive
