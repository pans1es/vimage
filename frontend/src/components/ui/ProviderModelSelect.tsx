  ...
  return (
    <div ref={containerRef} className={`relative ${className || ""}`}>
      ...
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-[8px] border border-hairline bg-field px-3 py-2 text-[13px] text-text transition-colors hover:border-hairline-strong hover:bg-field-muted/65 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      >
          ...
          >
            ...
            <div className="relative border-b border-hairline-soft p-2">
              ...
              <input
                ...
                autoComplete="off"
                spellCheck={false}
                className="w-full rounded-[6px] border border-hairline bg-field/65 py-1.5 pl-8 pr-2 text-[12.5px] text-text placeholder:text-text-4 focus:border-accent/55 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
              />
            </div>
          )}
          ...
          >
            {showDefault && (
              <button
                ...
                className={`flex w-full items-center gap-2 px-3 py-2 text-left text-[12.5px] transition-colors ${
                  activeIndex === 0 ? "bg-accent-dim text-text" : "text-text-2 hover:bg-field-muted"
                }`}
              >
            ...
            {Object.entries(filteredGrouped).map(([providerId, models]) => (
              <div key={providerId} role="presentation">
                ...
                <div
                  role="presentation"
                  className="flex items-center gap-1.5 px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.14em] text-text-4 bg-field-muted"
                >
                    ...
                    <button
                      ...
                      className={`flex w-full items-start gap-1.5 px-3 py-2 pl-6 text-left text-[12.5px] transition-colors ${
                        isActive
                          ...
                          : "text-text-2 hover:bg-field-muted"
                      }`}
                    >
                      {isSelected ? (
