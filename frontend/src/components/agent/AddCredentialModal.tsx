      ...
      >
                ...
                >
                  {providers.map((p) => (
                    <button
                      ...
                      className="block w-full truncate px-3 py-2 text-left text-[12px] text-text-2 hover:bg-field-muted"
                    >
                      {p.display_name}
                    </button>
                  ))}
        ...
        <div className="space-y-4">
          ...
          <details
            ...
            className="rounded-[8px] border border-hairline-soft bg-field-muted p-3"
          >
            <summary className="flex cursor-pointer list-none items-center justify-between">
              ...
              <span className="inline-flex h-6 w-6 items-center justify-center rounded-full border border-hairline-soft bg-field text-text-3">
                <ChevronDown
          ...
          {selected?.notes && (
            <div className="rounded-[8px] border border-hairline-soft bg-field-muted px-3 py-2 text-[11.5px] text-text-3">
              {selected.notes}
            </div>
          )}
    ...
    <button
      ...
      className={`group inline-flex items-center justify-start gap-1.5 truncate rounded-[8px] border px-2.5 py-1.5 text-left text-[12px] transition disabled:cursor-not-allowed disabled:opacity-60 ${
        selected
          ...
          : "border-hairline bg-field-muted text-text-2 hover:border-accent/40"
      }`}
    >
      {recommended && (
        <Star
