    ...
    >
      ...
      >
        ...
        <span
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 6%, var(--color-accent) 50%, transparent 94%)",
            opacity: 0.7,
        ...
        <span
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 100% at 50% 0%, var(--color-accent-soft) 0%, transparent 65%)",
            borderRadius: 14,
            mixBlendMode: "screen",
            overflow: "hidden",
          }}
        ...
        <span
          ...
          style={{
            ...
            borderRadius: 999,
            background:
              "linear-gradient(90deg, var(--color-accent) 0%, var(--color-accent-soft) 100%)",
        ...
        <div className="relative flex items-start gap-3.5">
          ...
          <button
            ...
            className="focus-ring pointer-events-auto -mr-1.5 -mt-1.5 shrink-0 inline-flex h-6 w-6 items-center justify-center rounded-md transition-colors hover:bg-field-muted"
