  ...
  return (
    ...
    >
      <div className="space-y-3 p-3.5">
        ...
        <pre className="max-h-40 overflow-auto whitespace-pre-wrap break-words rounded-lg border border-hairline-soft bg-field/60 p-2.5 font-mono text-[11px] leading-relaxed text-text-2">
      ...
      <details className="group border-t border-hairline-soft px-3.5 py-2 text-[11px] text-text-3">
        ...
        <pre
          ...
          className="mt-2 max-h-72 overflow-auto whitespace-pre-wrap break-words rounded-lg border border-hairline-soft bg-field/60 p-2.5 font-mono text-[10.5px] leading-relaxed"
        >
          {raw}
        </pre>
      </details>
