        ...
        >
          <div
            ...
            style={{
              ...
              background: previewUrl ? undefined : "var(--color-field-muted)",
            }}
          >
            ...
            {!viewOnly && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={controlsDisabled}
                  title={disabledHint}
                  className="focus-ring rounded-md px-2.5 py-1 text-[11.5px] font-medium transition-colors hover:bg-field-muted disabled:cursor-not-allowed disabled:opacity-50"
                  style={{
                    border: "1px solid var(--color-hairline)",
                ...
                {endFramePath && (
                  <button
                    ...
                    disabled={controlsDisabled}
                    title={disabledHint}
                    className="focus-ring rounded-md px-2.5 py-1 text-[11.5px] transition-colors hover:bg-field-muted disabled:cursor-not-allowed disabled:opacity-50"
