      ...
      <div className="min-w-0 flex-1 pb-2.5">
        <div className="mb-1 flex items-center gap-1.5">
          <button
            ...
            className="focus-ring inline-flex items-center gap-1 rounded-md border border-hairline bg-field px-1.5 py-0.5 text-[11px] text-text-3 transition-colors hover:border-hairline-strong hover:text-text disabled:opacity-50"
          >
            {isDialogue ? (
          ...
          {isDialogue && (
            <input
              ...
              className={`focus-ring w-24 rounded-md border bg-field px-2 py-0.5 text-[12px] text-text transition-colors disabled:opacity-50 ${
