...
function GuideSection({ meta }: { meta: EpisodeMeta | undefined }) {
  ...
  return (
    <section
      ...
      style={{ background: "var(--color-field-muted)", border: "1px solid var(--color-hairline)" }}
    >
      <button
        type="button"
            ...
            >
              {beats.map((b, i) => (
                <div
                  ...
                  style={{ background: "var(--color-field-muted)", border: "1px solid var(--color-hairline-soft)" }}
                >
