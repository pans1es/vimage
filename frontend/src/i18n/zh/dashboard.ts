...
export default {
  ...
  'optional': '可选',
  'creating': '创建中...',
  'rebirth_empress_example': '例如：重生之我回到了高考前三个月',
  'characters': '角色',
  'episodes': '分集',
  ...
  'speech_rate_hint_language_pending': '项目语言还未确定：中文项目按「字/秒」计，英文项目按「词/秒」计。语言确定后可在项目设置里调整。',
  ...
  'external_agent_install_command': '1. 安装 [[brand]] skills',
  ...
  'ce_group_builtin_empty': '未加载到火山方舟声明式端点。请重启后端（不是 Vite），再刷新本页。',
  'ce_kind_custom': '自定义',
