...
export default {
  ...
  'optional': 'Tùy chọn',
  'creating': 'Đang tạo...',
  'rebirth_empress_example': 'Ví dụ: Trùng sinh — trở lại ba tháng trước kỳ thi đại học',
  'characters': 'Nhân vật',
  'episodes': 'Tập',
  ...
  'about_powered_by': 'Chạy trên {{brand}}',
  ...
  'speech_rate_hint_language_pending': 'Ngôn ngữ dự án chưa được xác định: dự án tiếng Trung tính ký tự mỗi giây, dự án tiếng Anh tính từ mỗi giây. Bạn có thể điều chỉnh trong cài đặt dự án sau khi ngôn ngữ được xác định.',
  ...
  // vimage Workbench v3 — Video Tham Chiếu
  ...
  'external_agent_install_command': '1. Cài đặt [[brand]] skills',
  ...
  'ce_group_builtin_empty': 'Chưa tải được endpoint khai báo Volcengine Ark. Hãy khởi động lại backend (không phải Vite), rồi làm mới trang.',
