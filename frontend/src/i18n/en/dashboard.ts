...
export default {
  ...
  'optional': 'Optional',
  'creating': 'Creating...',
  'rebirth_empress_example': 'e.g., Reborn: Back Three Months Before the College Entrance Exam',
  ...
  'about_powered_by': 'Powered by {{brand}}',
  ...
  'speech_rate_hint_language_pending': 'The project language is not set yet: Chinese projects count characters per second, English projects count words per second. You can adjust this in project settings once the language is known.',
  ...
  // vimage Workbench v3 — Reference-to-Video
  ...
  // MCP tool display names (single source of truth: VIMAGE_MCP_TOOL_IDS in
  ...
  'external_agent_install_command': '1. Install [[brand]] skills',
  ...
  'ce_group_builtin_empty': 'Volcengine Ark declarative endpoint is missing. Restart the backend (not Vite), then refresh.',
  ...
  'ce_section_poll_desc': 'The request that checks a job, and where to read each field from its response. [[brand]] repeats it until the video URL or an error comes back.',
