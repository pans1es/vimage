...
def test_downgrade_rebuilds_task_events_with_named_fk(alembic_cfg: tuple[Config, Path]):
    ...
    try:
        ...
        command.downgrade(cfg, "b41d7c5e9a02")
    ...
    command.downgrade(cfg, _BELOW_FK_MIGRATION)
